...
import {
    ...
    fetchDataLoading,
    showConfirmDel,
} from "./dataSusunanPengurusService";
...
class DataSusunanPengurus extends Component {
    constructor(props) {
        super(props);
        this.initSelected = {
            susunan_pengurus_perusahaan_id: "",
            nama: "",
            jabatan: "",
        };
        this.state = {
    ...
    editRecord = async (record) => {
        let isLoading = true;
        let dataDetail;
        await fetchDataDetail(record.susunan_pengurus_perusahaan_id)
            .then((response) => {
    ...
    handleSubmit = async () => {
        ...
        errors.jabatan = !this.state.selected.jabatan ? "Jabatan required" : "";
    ...
    handleDelete = async () => {
        await this.props.onDelete(
            this.state.selected.susunan_pengurus_perusahaan_id
        );
        this.props.onLoad(
            "?search" +
            this.state.keyword +
    ...
    render() {
        ...
        if (
            allowedMenu &&
            (allowedMenu.susunan_pengurus_edit || allowedMenu.susunan_pengurus_delete)
        ) {
            columns = [
                ...columns,
                {
                    ...
                    cell: (record) => {
                        return (
                            <div style={{textAlign: "center"}}>
                                <Fragment>
                                    {allowedMenu && allowedMenu.susunan_pengurus_edit ? (
                                        <button
                                    ...
                                    {allowedMenu && allowedMenu.susunan_pengurus_delete ? (
                                        <button
        ...
        const config = {
            key_column: "susunan_pengurus_perusahaan_id",
            page_size: 10,
                        ...
                        <div className="container-fluid">
                            <div className="row mb-2">
                                <div className="col-sm-6">
                                    <h1 className="m-0">Data Susunan Pengurus</h1>
                                </div>
                                {/* /.col */}
                            </div>
                            {/* /.row */}
                        ...
                        <div className="container-fluid">
                            <div className="row">
                                <div className="col-12">
                                    ...
                                    >
                                        {allowedMenu && allowedMenu.susunan_pengurus_add ? (
...
const mapStateToProps = (state) => {
    return {
        data: state.dataSusunanPengurus.data || [],
        isLoading: state.dataSusunanPengurus.isLoading,
        isAddLoading: state.dataSusunanPengurus.isAddLoading,
        error: state.dataSusunanPengurus.error || null,
        errorPriority: state.dataSusunanPengurus.errorPriority || null,
        totalData: state.dataSusunanPengurus.totalData || 0,
        showFormAdd: state.dataSusunanPengurus.showFormAdd,
        contentMsg: state.dataSusunanPengurus.contentMsg,
        showFormSuccess: state.dataSusunanPengurus.showFormSuccess,
        showFormDelete: state.dataSusunanPengurus.showFormDelete,
        tipeSWAL: state.dataSusunanPengurus.tipeSWAL,
...
export default connect(mapStateToProps, mapDispatchToPros)(DataSusunanPengurus);
