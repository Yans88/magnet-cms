...
export const fetchData = (param) => {
    ...
    return async (dispatch) => {
        ...
        return await axios.get(API_URL + "/back-office/data-susunan-pengurus-perusahaan" + param, {
            headers: {
...
export const fetchDataDetail = (param) => {
    ...
    const dt_res = dt.toString(CryptoJS.enc.Utf8);
    const _dt = dt_res.split('Þ');
    return axios.get(API_URL + "/back-office/edit-data-susunan-pengurus-perusahaan/" + param, {
        headers: {
            'x-app-origin': 'backoffice-app',
            'Authorization': 'Bearer ' + _dt[0]
        }
...
export const addData = (param) => {
    ...
    return async (dispatch) => {
        ...
        const _data = {};
        await axios.post(API_URL + "/back-office/action-data-susunan-pengurus-perusahaan", param, {
            headers: {
                'x-app-origin': 'backoffice-app',
                'Authorization': 'Bearer ' + _dt[0]
            }
...
export const deleteData = (param) => {
    ...
    return async (dispatch) => {
        dispatch(fetchAddDataLoading(isLoading));
        const _data = {};
        await axios.get(API_URL + "/back-office/delete-data-susunan-pengurus-perusahaan/" + param, {
            headers: {
                'x-app-origin': 'backoffice-app',
                'Authorization': 'Bearer ' + _dt[0]
            }
