...
export const fetchDataSuccess = (data) => {
    return {
        type: FETCH_LEGALITAS_PERUSAHAAN,
        payload: data
    }
}
...
export const fetchData = (param = "") => {
    ...
    return async (dispatch) => {
        ...
        return await axios.get(API_URL + "/back-office/data-legalitas-perusahaan" + param, {
            headers: {
...
export const addData = (param) => {
    ...
    return async (dispatch) => {
        dispatch(fetchAddDataLoading(isLoading));
        const _data = {};
        await axios.post(API_URL + "/back-office/action-data-legalitas-perusahaan", param, {
            headers: {
                'x-app-origin': 'backoffice-app',
                'Authorization': 'Bearer ' + _dt[0]
            }
