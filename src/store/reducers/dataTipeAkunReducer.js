...
const dataTipeAkunReducer = (state = defaultState, action) => {
    switch (action.type) {
        case FETCH_DATA_TIPE_AKUN:
            return {...state, data: action.payload.data, totalData: action.payload.total_data}
        case FETCH_DATA_LIST_GROUP:
            return {...state, dataListGroup: action.payload}
...
export default dataTipeAkunReducer;