...
const dataPenarikanReducer = (state = defaultState, action) => {
    switch (action.type) {
        case FETCH_DATA_PENARIKAN:
            return {...state, data: action.payload.data, totalData: action.payload.total_data}
        case FETCH_DATA_SUCCESS_EXPORT_PENARIKAN:
            return {...state, data_report_penarikan: action.payload.data_report}
...
export default dataPenarikanReducer;