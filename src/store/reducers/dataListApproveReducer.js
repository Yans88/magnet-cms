...
const defaultState = {
    ...
    showConfirmAppr: false,
    tipeSWAL: "success",
}

const dataListApproveReducer = (state = defaultState, action) => {
    switch (action.type) {
        case FETCH_DATA_LISTAPPROVE:
        ...
        case FORM_APPROVE:
            return {
                ...state,
                isAddLoading: action.payload.isAddLoading,
                showConfirmAppr: action.payload.showFormApprove,
                errorPriority: action.payload.errorPriority
            }
...
export default dataListApproveReducer;