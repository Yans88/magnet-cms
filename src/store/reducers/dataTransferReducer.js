...
const dataTransferReducer = (state = defaultState, action) => {
    switch (action.type) {
        case FETCH_DATA_TRANSFER:
            return {...state, data: action.payload.data, totalData: action.payload.total_data}
        case FETCH_DATA_SUCCESS_EXPORT_SETORAN:
            return {...state, data_report_setor: action.payload.data_report}
...
export default dataTransferReducer;