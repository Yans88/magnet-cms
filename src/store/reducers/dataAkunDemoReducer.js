...
const dataAkunDemoReducer = (state = defaultState, action) => {
    switch (action.type) {
        case FETCH_DATA_AKUN_DEMO:
        ...
        case FORM_APPROVE:
            return {
                ...state,
                isAddLoading: action.payload.isAddLoading,
                showFormApprove: action.payload.showFormApprove,
                errorPriority: action.payload.errorPriority
            }
...
export default dataAkunDemoReducer;