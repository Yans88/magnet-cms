...
class DataNegara extends Component {
    constructor(props) {
        super(props);
        this.initSelected = {
            negara_id: "",
    ...
    handleSubmit = async () => {
        ...
        errors.nama_negara = !this.state.selected.nama_negara
            ? "Nama Negara required"
            : "";
    ...
    handleDelete = async () => {
        await this.props.onDelete(this.state.selected.negara_id);
        this.props.onLoad(
            "?search" +
            this.state.keyword +
            "&limit=" +
    ...
    render() {
        ...
        if (allowedMenu && (allowedMenu.negara_edit || allowedMenu.negara_delete)) {
            columns = [
                ...columns,
                {
                    key: "action",
                    ...
                    cell: (record) => {
                        return (
                            <div style={{textAlign: "center"}}>
                                <Fragment>
                                    {allowedMenu && allowedMenu.negara_edit ? (
                                        <button
                                    ...
                                    {allowedMenu && allowedMenu.negara_delete ? (
                                        <button
        ...
        const frmUser = (
            <Form id="myForm">
                <Form.Group controlId="nama_negara">
                    <Form.Label>Nama Negara</Form.Label>
                    {errMsg.nama_negara ? (
                        ...
                        <div className="container-fluid">
                            <div className="row mb-2">
                                <div className="col-sm-6">
                                    <h1 className="m-0">Data Negara</h1>
                                </div>
                                {/* /.col */}
                            </div>
                            {/* /.row */}
                        ...
                        <div className="container-fluid">
                            <div className="row">
                                <div className="col-12">
                                    ...
                                    >
                                        {allowedMenu && allowedMenu.negara_add ? (
...
const mapStateToProps = (state) => {
    return {
        data: state.dataNegara.data || [],
        isLoading: state.dataNegara.isLoading,
        isAddLoading: state.dataNegara.isAddLoading,
        error: state.dataNegara.error || null,
        errorPriority: state.dataNegara.errorPriority || null,
        totalData: state.dataNegara.totalData || 0,
        showFormAdd: state.dataNegara.showFormAdd,
        contentMsg: state.dataNegara.contentMsg,
        showFormSuccess: state.dataNegara.showFormSuccess,
        showFormDelete: state.dataNegara.showFormDelete,
        tipeSWAL: state.dataNegara.tipeSWAL,
...
export default connect(mapStateToProps, mapDispatchToPros)(DataNegara);
