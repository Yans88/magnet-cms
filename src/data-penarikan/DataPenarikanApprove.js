...
class DataPenarikanApprove extends Component {
    constructor(props) {
        super(props);
        this.initSelected = {
            penarikan_dana_id: "",
            ...
            },
            {
                ...
                cell: record => {
                    ...
                    />
                        ...
                        {record.rate > 0 &&
                            <NumberFormat
                                value={record.rate * record.nominal}
                                thousandSeparator={true}
                                decimalScale={2}
                                displayType={"text"}
                            />}
                        ...
                        <div className="container-fluid">
                            <div className="row mb-2">
                                <div className="col-sm-6">
                                    <h1 className="m-0">Data Transfer Dana - Approve</h1>
                                </div>
                                {/* /.col */}
                                                    ...
                                                    <div className="row">
                                                        <div className="col-md-12">
                                                            <div className="mb-4 pull-right">
                                                                ...
                                                                <div className="pull-left margin-left-10 max-w-250">
                                                                    <ExcelFile
                                                                        filename={"Report Penarikan-Approve " + this.state.start_date + ' to ' + this.state.end_date}
                                                                        element={
                                                                            <AppButton
                                                                                style={{marginTop: 30}}
...
export default connect(mapStateToProps, mapDispatchToPros)(DataPenarikanApprove);