...
import {
    ...
    FETCH_DATA_ERROR,
    FETCH_DATA_LOADING,
    FETCH_DATA_PENARIKAN,
    FETCH_DATA_SUCCESS_EXPORT_PENARIKAN,
    FORM_DATA,
    FORM_DELETE
...
export const fetchDataSuccessExportHeader = (data) => {
    return {
        type: FETCH_DATA_SUCCESS_EXPORT_PENARIKAN,
        payload: data
    }
}
...
export const fetchData = (param) => {
    ...
    return async (dispatch) => {
        ...
        return await axios.get(API_URL + "/back-office/penarikan-dana" + param, {
            headers: {
...
export const updData = (param) => {
    ...
    return async (dispatch) => {
        ...
        const _data = {};
        await axios.post(API_URL + "/back-office/approve-penarikan-dana", param, {
            headers: {
                'x-app-origin': 'backoffice-app',
                'Authorization': 'Bearer ' + _dt[0]
            }
            ...
            .then(response => {
                ...
                if (err_code === 0) {
                    ...
                    _data['contentMsg'] = <div
                        dangerouslySetInnerHTML={{__html: '<div style="font-size:20px; text-align:center;"><strong>Maaf</strong>, Tidak dapat melakukan penarikan dana</div>'}}/>;
                    dispatch(addDataSuccess(_data));
                }
