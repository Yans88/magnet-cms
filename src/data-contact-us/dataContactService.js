...
export const fetchData = (param, isLoadingku) => {
    let isLoading = isLoadingku;
    ...
    return async (dispatch) => {
        ...
        return await axios.get(API_URL + "/back-office/data-contact-us" + param, {
            headers: {
...
export const updateData = (param) => {
    ...
    return async (dispatch) => {
        ...
        const _data = {};
        await axios.post(API_URL + "/back-office/update-status-contact-us", param, {
            headers: {
                'x-app-origin': 'backoffice-app',
                'Authorization': 'Bearer ' + _dt[0]
            }
