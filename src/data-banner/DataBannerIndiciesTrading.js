...
class DataBannerIndiciesTrading extends Component {
    constructor(props) {
        super(props);
        this.initSelected = {
            banner_id: "",
        ...
        this.state = {
            ...
            loadingForm: false,
            tipeBannerMagnet: 'market_indicies',
            sectionBannerMagnet: 'trading_indicies_magnet'
        }
    }
    ...
    componentDidMount() {
        ...
        this.props.onLoad("?search=" + this.state.keyword + "&limit=" + this.state.per_page + "&start=" + (this.state.page_number - 1) + "&tipe=market_indicies&section=trading_indicies_magnet");
    }
                        ...
                        <div className="container-fluid">
                            <div className="row mb-2">
                                <div className="col-sm-6">
                                    <h1 className="m-0">Data Banner Market Indicies - Trading</h1>
                                </div>
                                {/* /.col */}
...
const mapDispatchToPros = (dispatch) => {
    return {
        ...
        closeSwal: () => {
            ...
            dispatch(fetchData("?limit=10&start=" + 0 + "&tipe=market_indicies&section=trading_indicies_magnet"));
        },
        clearErrProps: () => {
...
export default connect(mapStateToProps, mapDispatchToPros)(DataBannerIndiciesTrading);