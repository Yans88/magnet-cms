...
class DataBannerMetatrader5Benefit extends Component {
    constructor(props) {
        super(props);
        this.initSelected = {
            banner_id: "",
        ...
        this.state = {
            ...
            loadingForm: false,
            tipeBannerMagnet: 'metatrader5',
            sectionBannerMagnet: 'benefit_user_metatrader5'
        }
    }
    ...
    componentDidMount() {
        ...
        this.props.onLoad("?search=" + this.state.keyword + "&limit=" + this.state.per_page + "&start=" + (this.state.page_number - 1) + "&tipe=metatrader5&section=benefit_user_metatrader5");
    }
                        ...
                        <div className="container-fluid">
                            <div className="row mb-2">
                                <div className="col-sm-6">
                                    <h1 className="m-0">Data Banner Metatrader5 - Benefit User</h1>
                                </div>
                                {/* /.col */}
...
const mapDispatchToPros = (dispatch) => {
    return {
        ...
        closeSwal: () => {
            ...
            dispatch(fetchData("?limit=10&start=" + 0 + "&tipe=metatrader5&section=benefit_user_metatrader5"));
        },
        clearErrProps: () => {
...
export default connect(mapStateToProps, mapDispatchToPros)(DataBannerMetatrader5Benefit);