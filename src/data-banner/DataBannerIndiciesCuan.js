...
class DataBannerIndiciesCuan extends Component {
    constructor(props) {
        super(props);
        this.initSelected = {
            banner_id: "",
        ...
        this.state = {
            ...
            sectionBannerMagnet: 'siap_cuan_indicies'
        }
    }
    ...
    componentDidMount() {
        ...
        this.props.onLoad("?search=" + this.state.keyword + "&limit=" + this.state.per_page + "&start=" + (this.state.page_number - 1) + "&tipe=market_indicies&section=siap_cuan_indicies");
    }
                        ...
                        <div className="container-fluid">
                            <div className="row mb-2">
                                <div className="col-sm-6">
                                    <h1 className="m-0">Data Banner Market Indicies - Siap Cuan</h1>
                                </div>
                                {/* /.col */}
...
const mapDispatchToPros = (dispatch) => {
    return {
        ...
        closeSwal: () => {
            ...
            dispatch(fetchData("?limit=10&start=" + 0 + "&tipe=market_indicies&section=siap_cuan_indicies"));
        },
        clearErrProps: () => {
...
export default connect(mapStateToProps, mapDispatchToPros)(DataBannerIndiciesCuan);