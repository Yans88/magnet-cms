...
class DataNewBankReject extends Component {
    constructor(props) {
        super(props);
        this.initSelected = {
            akun_bank_id: "",
                        ...
                        <div className="container-fluid">
                            <div className="row mb-2">
                                <div className="col-sm-6">
                                    <h1 className="m-0">Data New Akun Bank - Rejected</h1>
                                </div>
                                {/* /.col */}
                            </div>
                            {/* /.row */}
...
export default connect(mapStateToProps, mapDispatchToPros)(DataNewBankReject);
