...
export const fetchData = (param) => {
    ...
    return async (dispatch) => {
        ...
        return await axios.get(API_URL + "/back-office/get-akun-bank" + param, {
            headers: {
...
export const updData = (param) => {
    ...
    return async (dispatch) => {
        ...
        const _data = {};
        return await axios.get(API_URL + "/back-office/approve-akun-bank" + param, {
            headers: {
                'x-app-origin': 'backoffice-app',
                'Authorization': 'Bearer ' + _dt[0]
            }
