...
class DataSetoranApprove extends Component {
    constructor(props) {
        super(props);
        this.initSelected = {
            setor_id: "",
        ...
        const multiDataSet = [
            {
                ...
                data: data_report_setor
                    ...
                    .map((data) => [
                        ...
                        {value: data.jml_setor ? data.jml_setor : ""},
                        ...
                        <div className="container-fluid">
                            <div className="row mb-2">
                                <div className="col-sm-6">
                                    <h1 className="m-0">Data Setoran - Approve</h1>
                                </div>
                                {/* /.col */}
                            </div>
                            {/* /.row */}
...
export default connect(mapStateToProps, mapDispatchToPros)(DataSetoranApprove);
