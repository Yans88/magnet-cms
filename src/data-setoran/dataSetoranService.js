...
export const fetchDataSuccessExportHeader = (data) => {
    return {
        type: FETCH_DATA_SUCCESS_EXPORT_SETORAN,
        payload: data
    }
}
...
export const fetchData = (param) => {
    ...
    return async (dispatch) => {
        ...
        return await axios.get(API_URL + "/back-office/setor" + param, {
            headers: {
    ...
    return async (dispatch) => {
        ...
        return await axios.get(API_URL + "/back-office/setor" + param, {
            ...
            .then(response => {
                const data = {};
                if (response.data.error_message === 0) {
                    data['data_report'] = response.data.payload.data;
                    data['waktu_server'] = response.data.payload.waktu_server;
...
export const updData = (param) => {
    ...
    return async (dispatch) => {
        ...
        const _data = {};
        await axios.post(API_URL + "/back-office/approve-setor", param, {
            headers: {
                'x-app-origin': 'backoffice-app',
                'Authorization': 'Bearer ' + _dt[0]
            }
            ...
            .then(response => {
                ...
                if (err_code === 0) {
                    ...
                    _data['contentMsg'] = <div
                        dangerouslySetInnerHTML={{__html: '<div style="font-size:20px; text-align:center;"><strong>Failed</strong><br/> ' + response.data.message + '</div>'}}/>;
                    dispatch(addDataSuccess(_data));
                }
...
export const fetchDataDetail = (param) => {
    ...
    const dt_res = dt.toString(CryptoJS.enc.Utf8);
    const _dt = dt_res.split('Þ');
    return axios.get(API_URL + "/back-office/edit-setor/" + param, {
        headers: {
            'x-app-origin': 'backoffice-app',
            'Authorization': 'Bearer ' + _dt[0]
        }
