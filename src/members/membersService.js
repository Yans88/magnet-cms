...
export const fetchDataSuccess = (data) => {
    return {
        type: FETCH_DATA_SUCCESS_MEMBERS,
        payload: data
    }
}
...
export const fetchData = (param) => {
    ...
    return async (dispatch) => {
        ...
        return await axios.post(API_URL + "/members", param)
            .then(response => {
                const data = {};
...
export const addData = (param) => {
    ...
    return async (dispatch) => {
        ...
        const _data = {};
        await axios.post(API_URL + "/add_satgas", param)
            .then(response => {
...
export const deleteData = (param) => {
    ...
    return async (dispatch) => {
        dispatch(fetchAddDataLoading(isLoading));
        const _data = {};
        await axios.post(API_URL + "/del_satgas", param)
            .then(response => {
